Seaborn (sns) ofrece varios tipos de gráficos para la visualización de datos y cada uno tiene argumentos específicos que puedes usar para personalizar las visualizaciones. A continuación te doy una lista de los gráficos más comunes en Seaborn junto con los argumentos esenciales.
